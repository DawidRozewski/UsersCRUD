                ...
                <table class="table">
                    ...
                    <c:forEach  var="user" items="${users}">
                        <tr>
                            ...
                            <td>${user.email}</td>
                            <td>
                                <a href='<c:url value="/user/delete?id=${user.id}"/>' class="btn btn-outline-danger">Usuń</a>
                                <a href='<c:url value="/user/edit?id=${user.id}"/>' class="btn btn-outline-primary">Edytuj</a>
                                <a href='<c:url value="/user/show?id=${user.id}"/>' class="btn btn-outline-dark">Pokaż</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
